...
export async function listCarteiras(scope: CarteiraScope) {
  ...
  let query = supabase
    .from('carteiras')
    .select('id, nome, descricao, ativo, pre_juridico_habilitado, email_habilitado, whatsapp_habilitado, whatsapp_remetente_modo, whatsapp_numero_proprio, percentual_participacao_resultado, nfse_emissor_cnpj, created_at')
