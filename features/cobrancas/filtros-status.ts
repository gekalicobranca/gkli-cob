...
export const STATUS_BLOQUEIOS = [STATUS.ACORDO_EFETIVADO, STATUS.PRE_JURIDICO, STATUS.JUDICIALIZADO, STATUS.SUSPENSO]
export const STATUS_OPERACIONAIS = [STATUS.NOVO, STATUS.EM_COBRANCA_ATIVA, STATUS.EM_NEGOCIACAO, STATUS.POSSIVEL_ACORDO, STATUS.ACORDO_FIRMADO]
const STATUS_FILA = [STATUS.NOVO, STATUS.EM_COBRANCA_ATIVA, STATUS.EM_NEGOCIACAO, STATUS.POSSIVEL_ACORDO]
