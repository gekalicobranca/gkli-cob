...
const variants: Record<ButtonVariant, string> = {
  primary: 'border-transparent bg-[var(--gkli-primary)] text-white hover:bg-[var(--gkli-primary-hover)]',
  ...
  header: 'border-white/25 bg-white/10 text-white hover:bg-white/16'
}
const sizes: Record<ButtonSize, string> = { sm: 'h-9 px-3 text-[12px]', md: 'h-10 px-4 text-[13px]' }
const base = 'inline-flex items-center justify-center gap-2 rounded-xl border font-medium tracking-[-0.005em] shadow-sm transition disabled:cursor-not-allowed disabled:opacity-60'
