...
export function FiltrosSindico({ condominios, selecionado, periodo, ultima }: {
  condominios: { id: string; nome: string }[]; selecionado?: string; periodo: PeriodoSindico; ultima: string
}) {
  ...
  return (
    <form action="/sindico/visao-v2" method="get" className="grid gap-4 rounded-2xl border border-slate-200 bg-white p-5 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_auto] lg:items-end">
