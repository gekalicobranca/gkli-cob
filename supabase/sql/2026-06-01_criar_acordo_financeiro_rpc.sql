-- Cria o nucleo financeiro do acordo de forma atomica.
-- A funcao inteira roda em uma unica transacao do Postgres:
-- acordo, vinculos, parcelas e status das cobrancas entram juntos ou nao entram.
