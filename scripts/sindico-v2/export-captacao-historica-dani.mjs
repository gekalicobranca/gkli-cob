...
const defaultSource = path.join(workspace, '.codex-tmp/dani-conciliacao/reconciliation.json')
const defaultOutput = path.join(workspace, 'outputs/dani-conciliacao-20260907/captacao-historica-dani-2026-01-07-parcial.sql')

const source = process.argv[2] ?? defaultSource
const output = process.argv[3] ?? defaultOutput
const origem = 'dani_cronograma_2026_01_07'
...
const content = `-- Captação histórica Dani, arquivos encontrados de 01/2026 e 03/2026 a 07/2026.
-- O arquivo 02/2026 não foi localizado na pasta Downloads durante esta geração.
