...
const defaultSource = path.join(workspace, '.codex-tmp/lote-conciliacao/reconciliation.json')
const defaultOutput = path.join(workspace, 'outputs/lote-cronograma-20260907/captacao-historica-lote-2026-02-07-parcial.sql')

const source = process.argv[2] ?? defaultSource
const output = process.argv[3] ?? defaultOutput
const origem = 'lote_cronograma_2026_02_07'
...
const content = `-- Captação histórica do lote sem operador, arquivos enviados de 02/2026, 03/2026, 04/2026, 06/2026 e 07/2026.
