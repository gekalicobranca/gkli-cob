...
const importTypes = [
  ...
  },
  {
    ...
    rule: "Unidades são vinculadas ao condomínio pelo CNPJ. Linhas sem condomínio existente ficam bloqueadas para evitar cadastro solto. Quando a importação for aberta pelo Condomínio Integral, o CNPJ pode ser dispensado e o condomínio da página será usado como padrão.",
  },
  {
    value: "acordos_extra",
