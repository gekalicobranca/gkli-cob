...
export default async function MonitorPreJuridicoPage({ searchParams }: { searchParams: Params }) {
  ...
  return <div className="space-y-5">
    ...
    <ListPanel><ListPanelHeader><ListTitle title="Fluxo dos casos" description="Role horizontalmente para ver todas as etapas. Abra um cartão para atualizar o andamento." /></ListPanelHeader><div className="p-3"><PreJuridicoCasosBoard casos={casos as any[]} /></div></ListPanel>
