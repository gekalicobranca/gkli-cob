  ...
  return (
    <div className="space-y-5">
      ...
      <Card className="space-y-4">
        <div><h2 className="text-base font-medium text-slate-950">Templates operacionais</h2><p className="mt-1 text-sm text-slate-500">Modelos usados nas solicitações para administradoras.</p></div>
        <div className="grid gap-3 md:grid-cols-2">
          {templates.length === 0 ? <p className="text-sm text-slate-500">Nenhum template ADM encontrado.</p> : templates.map((template) => (
