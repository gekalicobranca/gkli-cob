              ...
              {rows.map((row: any) => {
                ...
                return (
                  <Link
                    ...
                    className="group grid gkli-compact-row gap-4 px-5 py-3 transition hover:bg-slate-50 xl:grid-cols-[minmax(320px,1.4fr)_150px_150px_170px_120px] xl:items-center"
                  >
